...
//                Glide.with(iv.getContext()).load(url).into(iv);
    ...
    @Override
    protected void onActivityResult(int requestCode, int resultCode, final Intent data) {   //选择一一张图片
    ...
    private void postVideo() {
        ...
        Call<PostVideoResponse>postVideoResponseCall=getResponseWithRetrofitAsync3(this);
        ...
        postVideoResponseCall.enqueue(new Callback<PostVideoResponse>() {
            ...
            public void onResponse(Call<PostVideoResponse> call, Response<PostVideoResponse> response) {
                ...
                mBtn.setText("select an image please");
    ...
    public static Call<PostVideoResponse> getResponseWithRetrofitAsync3(Solution2C2Activity obj){
